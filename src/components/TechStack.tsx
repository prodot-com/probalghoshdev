...
const TechStackColorfull = [
  ...
  { name: "Next.js", category: "framework", icon: "/tech-icons/next.svg" },
  ...
  { name: "Prisma", category: "tool", icon: "/tech-icons/prisma2.svg" },
...
const TechStack = [
  ...
  { name: "Google Cloud", category: "tool", icon: "/tech-icons/google-cloud.svg" },
  { name: "Postman", category: "tool", icon: "/tech-icons/postman.svg" },
  { name: "Prisma", category: "tool", icon: "/tech-icons/prisma.svg" },
  { name: "Github", category: "tool", icon: "/tech-icons/github.svg" },
  { name: "Vercel", category: "tool", icon: "/tech-icons/vercel.svg" },
