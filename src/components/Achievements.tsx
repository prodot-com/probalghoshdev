...
const achievements: AchievementItem[] = [
  {
    icon: "/ieee.png", // add IEEE logo in public folder
    title: "IEEE Conference Publication – ICRCICN 2025",
    subname:
      "Multimodal Sensor Fusion for Heart Disease Prediction (90.67% Accuracy)",
    year: "2025",
    link: "https://ieeexplore.ieee.org/", // replace with actual DOI link
  },
];
