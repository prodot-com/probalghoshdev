...
export function Footer() {
  ...
  return (
    <div className="min-h-42.5">
      <div className="p-3 flex flex-col items-center justify-between gap-2 w-full mb-2">
        <div className="flex items-start">
          <p className="flex items-center gap-1">
            <Copyright className="w-5 sm:w-5" />
            <span className="instrument-serif text-[15px] sm:text-[19px]">
              {date.getFullYear()} Designed & Developed by{" "}
              <span className="text-[15px] md:text-[19px] instrument-serif-bold underline ">
                Probal.
              </span>
            </span>
          </p>
        </div>
        <p className="instrument-serif text-[15px] sm:text-[19px] flex items-start">
          Asia/Kolkata
        </p>
      </div>
